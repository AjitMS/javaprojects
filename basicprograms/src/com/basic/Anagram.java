...
public class Anagram {
	...
	/**
	 * @param args
	 * A Simple program to implement Anagram
	 * (if String is comes to be equal to another string after certain combinations,
	 * then 2 strings are said to be anagram of each other
	 */
