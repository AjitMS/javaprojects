package com.basic.cliniqueManagement;
...
public class CliniqueManager {
	...
	String appointmentFile = "src/textfiles/DocPatMapping.json";
	String patientsFile = "src/textfiles/Patient.json";
	String doctorsFile = "src/textfiles/Doctor.json";
